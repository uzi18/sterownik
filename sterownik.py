...
class sterownik:
	...
	def setPompaCO(self, state):
		if (state):
			self._getRequest("02010005000D0100018D03");
		else:
			self._getRequest("02010005000D010000BC03");
	...
	def setPompaCWU(self, state):
		if (state):
			self._getRequest("02010005000E0100011103");
		else:
			self._getRequest("02010005000E0100002003");
