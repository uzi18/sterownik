...
#define SENSOR_RESOLUTION 10 //rozdzielczosc 10 (0,25 st, 187,5 ms) 
...
void loop() {
  ...
  //delay(188); // The above doesn't seem to work for everyone (why?)
  delayInMillis = 750 / (1 << (12 - SENSOR_RESOLUTION)); //ustawia delay
  delay(delayInMillis); //wlacza ustawiony delay
 
  sensors.begin(); //start up temp sensor
  sensors.getAddress(sensorDeviceAddress, 0); //pobiera adres ds-a
  sensors.setResolution(sensorDeviceAddress, SENSOR_RESOLUTION); //ustawia rozdzielczosc
